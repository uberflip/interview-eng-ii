...
If you close a preview window, you can re-open it by clicking on the Remote tab on the left-hand sidebar.  Find the port you want to preview (e.g. `8080`) and click the Open Preview or Open Browser icon.
...
### NGINX (Web Server)
Available on port `8080`.  Default config is in /config/nginx.conf and will serve content out of /web/.